    ...
    <div className="bg-background">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src="https://storage.googleapis.com/a1aa/image/09192c73-f93d-4c31-9a74-d2e5a7d65384.png"
            ...
            {[
              {
                ...
                img: "https://storage.googleapis.com/a1aa/image/24227ce2-9333-40a8-b61d-381c8530342a.png"
              },
              {
                name: "Caramel Macchiato",
                desc: "Rich espresso layered with vanilla syrup and caramel drizzle.",
                img: "https://storage.googleapis.com/a1aa/image/9189286d-31eb-4752-9721-395781a74d28.png"
              },
              {
                name: "Signature Chocolate",
                desc: "Decadent dark chocolate blended with velvety steamed milk.",
                img: "https://storage.googleapis.com/a1aa/image/9c0f9175-01e4-4114-8785-5206461975e5.png"
              }
            ].map((drink, i) => (
              <motion.div
                key={i}
              ...
              >
                <div className="relative w-full aspect-square bg-background rounded-full overflow-hidden flex items-center justify-center p-8 transition-transform duration-500 group-hover:scale-105">
                  <img src={drink.img} alt={drink.name} className="w-full h-full object-contain transition-transform duration-700 group-hover:scale-110" />
                </div>
      ...
      <section className="py-24 md:py-32 bg-background overflow-hidden">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            >
              <div className="aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl bg-white flex items-center justify-center p-8">
                <img
                  src="https://storage.googleapis.com/a1aa/image/34493397-2a62-4f7f-85f0-827d057777ca.png"
                  alt="Coffee Splash"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                img: "https://images.unsplash.com/photo-1495474472207-464a8d9136ce?q=80&w=800&auto=format&fit=crop"
              },
              {
                name: "Pistachio Latte",
                desc: "Rich espresso combined with our house-made pistachio cream.",
                img: "https://images.unsplash.com/photo-1585494156145-1c60a4fe952b?q=80&w=800&auto=format&fit=crop"
              },
              {
                name: "Cold Brew",
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              "https://images.unsplash.com/photo-1495474472207-464a8d9136ce?q=80&w=800&auto=format&fit=crop",
